...
const t = "chart-timeline-grid-row-cell",
  i = "chart-timeline-items-row-item";
function e(t = {}) {
  const i = {
    enabled: !0,
    isMoving: !1,
    ...
    targetType: "",
    targetData: null,
    captureEvents: { down: !1, up: !1, move: !1 },
    initialPosition: { x: 0, y: 0 },
    currentPosition: { x: 0, y: 0 },
    movement: { x: 0, y: 0 },
    events: { down: null, move: null, up: null },
  };
  return (
    t.captureEvents &&
      (i.captureEvents = Object.assign(
        Object.assign({}, i.captureEvents),
        t.captureEvents
      )),
    i
  );
}
const a = "TimelinePointer",
  s = `config.plugin.${a}`;
class n {
  constructor(a, n) {
    (this.locked = { up: !1, move: !1, down: !1 }),
      (this.initialScrollPosPx = { horizontal: 0, vertical: 0 }),
      (this.onDestroy = []),
      (this.classNames = { cell: "", item: "" }),
      (this.api = n.api),
      (this.state = n.state),
      ...
      this.onDestroy.push(
        this.state.subscribe("$data.elements.chart-timeline", (t) => {
          t &&
            ((this.element = t),
      ...
      (this.apiRemovePointerListener =
        this.apiRemovePointerListener.bind(this)),
  ...
  getRealTarget(e) {
    ...
    return (
      a ||
      ((a = e.target.closest("." + this.classNames.cell)),
      a ||
  ...
  pointerDown(e) {
    ...
    (this.initialScrollPosPx.horizontal = this.state.get(
      "$data.scroll.horizontal.handlePosPx"
    )),
      (this.initialScrollPosPx.vertical = this.state.get(
        "$data.scroll.vertical.handlePosPx"
      )),
      (this.data.pointerState = "down"),
      (this.data.currentTarget = e.target);
    const a = this.getRealTarget(e);
    if (
      ((this.data.realTarget = a),
      (this.data.targetType = ""),
      (this.data.targetData = null),
      this.data.realTarget)
    )
  ...
  pointerUp(t) {
    ...
    (this.data.pointerState = "up"),
      ...
      (this.data.events.up = t),
      (this.data.currentPosition = this.getRealPosition(t));
    const i = {
      type: this.data.pointerState,
      originalEvent: t,
    ...
    this.apiTriggerPointerListener("up", i),
  ...
  pointerMove(t) {
    ...
    (this.data.pointerState = "move"),
      (this.data.events.move = t),
      (this.data.currentPosition = this.getRealPosition(t)),
      (this.data.movement.x =
        this.data.currentPosition.x - this.data.initialPosition.x),
      (this.data.movement.y =
        this.data.currentPosition.y - this.data.initialPosition.y),
      (this.data.movement.x += i - this.initialScrollPosPx.horizontal);
    const e = {
      type: this.data.pointerState,
      originalEvent: t,
      targetElement: this.data.realTarget,
...
function o(t = {}) {
  return function (i) {
    ...
    i.state.update(s, h);
    const l = new n(t, i);
    return a.pluginInitialized("TimelinePointer"), l.destroy;
  };
}
export { t as CELL, i as ITEM, o as Plugin };
